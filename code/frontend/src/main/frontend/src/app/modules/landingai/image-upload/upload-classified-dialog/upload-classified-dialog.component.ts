...
export interface UploadClassifiedDialogData {
  projectId: number;
}

export interface ClassifiedUploadResult {
  success: boolean;
  totalImages: number;
...
@Component({
  selector: "app-upload-classified-dialog",
  standalone: false,
  templateUrl: "./upload-classified-dialog.component.html",
  styleUrls: ["./upload-classified-dialog.component.scss"],
})
export class UploadClassifiedDialogComponent implements OnDestroy {
  selectedFile: File | null = null;
  isDragging = false;
  isUploading = false;
  uploadProgress = 0;
  uploadResult: ClassifiedUploadResult | null = null;
  errorMessage: string | null = null;

  private destroy$ = new Subject<void>();

  constructor(
    public dialogRef: MatDialogRef<UploadClassifiedDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: UploadClassifiedDialogData,
  ...
  uploadFile(): void {
    ...
    this.imageService
      .uploadClassifiedImagesZip(this.selectedFile, this.data.projectId)
