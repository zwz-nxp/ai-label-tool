...
/**
 * DTO for model parameter creation requests with validation annotations. Used when creating a new
 * model parameter configuration via the API. Validates: Requirements 7.1, 7.2, 7.3, 7.4, 7.5
 */
public class ModelParamCreateRequest {
  ...
  public ModelParamCreateRequest() {}

  public ModelParamCreateRequest(String modelName, String modelType, String parameters) {
